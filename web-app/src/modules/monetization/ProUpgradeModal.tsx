...
const CountdownBanner = () => {
  ...
  return (
    <motion.div
      ...
      className="mt-[20rem] sm:mt-[22rem] md:mt-[24rem] mb-4 md:mb-6 flex flex-col items-center justify-center gap-3 w-full transform-gpu"
    >
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden">
          ...
          <motion.div 
            ...
            className="relative w-full h-full max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 overflow-y-auto md:overflow-visible custom-scrollbar p-6 pt-24 md:p-12 md:pt-20 transform-gpu"
          >
            <button 
              onClick={onClose}
            ...
            <div className="flex-1 flex flex-col items-center md:items-center text-center md:text-center z-10 w-full max-w-xl shrink-0 justify-center">
              ...
              <motion.h2 
                ...
                className="text-4xl sm:text-5xl md:text-7xl font-black text-white mb-4 md:mb-6 tracking-tighter leading-[1.1] transform-gpu"
              >
              ...
              <motion.p 
                ...
                className="text-base md:text-xl text-white/50 mb-6 md:mb-8 max-w-md font-medium leading-relaxed mx-auto transform-gpu"
              >
              ...
              <div className="w-full flex flex-col items-center justify-center mb-12 md:mb-0 mt-2">
                {isNative ? (
                  <motion.button
                    ...
                    className="relative w-[90%] sm:w-[80%] md:w-auto mx-auto overflow-hidden rounded-full group shadow-[0_0_50px_rgba(168,85,247,0.6)] hover:shadow-[0_0_80px_rgba(168,85,247,0.9)] transition-shadow duration-300 border border-purple-500/50 bg-[#0a0014] transform-gpu"
                  >
                ...
                {features.map((feature, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`p-5 md:p-6 rounded-[24px] bg-[#1a0f2e]/40 border border-white/[0.08] hover:border-white/[0.15] transition-all duration-300 flex flex-row sm:flex-col items-center sm:items-start gap-4 text-left shadow-lg ${feature.shadow} transform-gpu`}
                    >
