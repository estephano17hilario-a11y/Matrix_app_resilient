      ...
      >
        ...
        <div className="text-center space-y-2">
          ...
          <motion.p 
            ...
            className="font-mono text-xs text-emerald-400 tracking-wider"
          >
        ...
        {/* ERROR DISPLAY */}
        {error && (
          <div className="w-full p-3 bg-red-500/10 border border-red-500/20 rounded-lg text-red-400 text-xs font-mono text-center">
            ERROR: {error}
          </div>
        )}
        ...
        <div className="w-full space-y-4">
          <motion.button
            ...
            className="w-full h-[56px] rounded-xl bg-white text-black font-semibold text-lg flex items-center justify-center gap-3 shadow-lg shadow-white/10 hover:shadow-white/20 transition-all"
          >
