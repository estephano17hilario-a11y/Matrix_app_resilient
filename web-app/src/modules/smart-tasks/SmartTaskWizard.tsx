...
export const SmartTaskWizard: React.FC<SmartTaskWizardProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-[50px] overflow-hidden">
      ...
      <div className="w-full max-w-4xl px-6 relative z-10 h-full flex flex-col justify-center">
              <AnimatePresence mode="popLayout">
                {isStarting ? (
                  <motion.div
                    ...
                    className="flex flex-col items-center justify-center text-center space-y-6 w-full h-full"
                  >
