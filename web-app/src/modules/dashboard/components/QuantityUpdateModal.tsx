            ...
            {isOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="absolute inset-0 bg-[#050505]/85 backdrop-blur-sm transform-gpu "
                    />
                    ...
                    >
                         ...
                         <motion.div 
                             ...
                             className="absolute -top-[20%] -left-[20%] w-[100%] h-[60%] pointer-events-none transform-gpu backface-hidden will-change-transform"
                             style={{ 
                                ...
                                >
                                    {isEditing ? (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2 mt-4 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.08] backdrop-blur-sm transform-gpu backface-hidden ">
