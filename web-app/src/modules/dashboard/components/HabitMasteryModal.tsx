      ...
      {isOpen && displayHabit && (
        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-[95%] max-w-[420px] bg-[#0a0a0c] border border-white/[0.12] rounded-[40px] overflow-y-auto max-h-[90vh] shadow-[0_30px_90px_-20px_rgba(0,0,0,0.8)] z-10 no-scrollbar"
          >
            ...
            <motion.div 
              ...
              className="absolute -top-[10%] -left-[10%] w-[120%] h-[60%] opacity-20 pointer-events-none transform-gpu backface-hidden will-change-transform"
              style={{
                    ...
                    >
                      <div className="relative mb-3 flex flex-col items-center justify-center">
                        ...
                        <motion.div 
                          ...
                          className="absolute inset-0 bg-emerald-400 blur-sm transform-gpu backface-hidden -z-10 opacity-20"
                        />
                      </div>
