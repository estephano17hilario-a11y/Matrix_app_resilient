          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            >
              ...
              {!showFilters && activeFiltersCount > 0 && (
                  <span className="absolute -top-1 -right-1 w-3 h-3 bg-indigo-500 rounded-full border border-black flex items-center justify-center text-[8px] text-white font-bold">
                      {activeFiltersCount}
                  </span>
              )}
            </button>
