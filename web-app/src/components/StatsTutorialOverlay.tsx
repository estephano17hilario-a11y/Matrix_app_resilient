...
export const StatsTutorialOverlay: React.FC<StatsTutorialOverlayProps> = ({ isOpen, onClose }) => {
 ...
 <div className="bg-fuchsia-500/5 p-4 rounded-2xl border border-fuchsia-500/10">
 ...
 <div className="absolute inset-0 bg-[radial-gradient(circle,_rgba(250,204,21,0.2)_0%,_transparent_70%)] rounded-full animate-pulse" style={{ opacity: 0.8 }} />
 ...
 className="w-full max-w-md bg-[#121214]/95 border border-white/10 rounded-3xl overflow-hidden shadow-[0_0_50px_-12px_rgba(0,0,0,1)] relative"
 >
 ...
 className="absolute top-4 right-4 w-8 h-8 rounded-full bg-black/60 border border-white/10 text-white/50 flex items-center justify-center hover:bg-white/10 hover:text-white transition-all z-20 hover:scale-110 active:scale-95"
 >
 <X size={16} />
 </button>
