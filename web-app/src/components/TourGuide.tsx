...
export const TourProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
 ...
 { id: 'create', target: '[data-tour="dock-main-btn"]', title: t('tour.onboarding.create.title', 'Create Mission'), description: t('tour.onboarding.create.desc', 'The task creator will open automatically.'), subtext: t('tour.onboarding.create.sub', 'Get ready!'), icon: Zap, position: 'top', action: { type: 'OPEN_QUEST_MODAL' }, interaction: 'wait-event', awaitEvent: 'quest-created', highlightPadding: 8 },
 ],
 tasks: [
 ...
 { id: 'tasks-create', position: 'center', title: t('tour.tasks.create.title', "It's your turn!"), description: t('tour.tasks.create.desc', "Let's create your first task right now."), subtext: t('tour.tasks.create.sub', 'The creator will open automatically.'), icon: Plus, action: { type: 'OPEN_QUEST_MODAL' }, interaction: 'wait-event', awaitEvent: 'quest-created' },
 ],
 habits: [
 ...
 { id: 'habits-create-bad', position: 'center', title: t('tour.habits.createBad.title', 'Identify a Vice'), description: t('tour.habits.createBad.desc', 'Now, declare war on a bad habit.'), subtext: t('tour.habits.createBad.sub', 'We will open the creator. Click Next.'), icon: Plus, action: { type: 'OPEN_HABIT_MODAL' }, interaction: 'next' },
 { id: 'habits-switch-vice', target: '[data-tour="habit-modal-vice-switch"]', title: t('tour.habits.switchVice.title', 'Switch to Vice'), description: t('tour.habits.switchVice.desc', 'Click here to switch to Vice mode.'), icon: Pointer, position: 'bottom', interaction: 'click', highlightPadding: 8 },
 { id: 'habits-save-bad', position: 'center', title: t('tour.habits.saveBad.title', 'Save the Vice'), description: t('tour.habits.saveBad.desc', 'Complete the form and save it.'), icon: Target, interaction: 'wait-event', awaitEvent: 'bad-habit-created' },
 ],
 focus: [
 ...
 { id: 'focus-create', position: 'center', title: t('tour.focus.create.title', 'New Project'), description: t('tour.focus.create.desc', 'Start planning your next big goal.'), subtext: t('tour.focus.create.sub', 'The creator will open automatically.'), icon: Plus, action: { type: 'OPEN_PROJECT_MODAL' }, interaction: 'wait-event', awaitEvent: 'project-created' },
 ],
 store: [
...
const TourOverlay: React.FC<{
 ...
 >
 <div className="bg-[#1c1c1e]/90 backdrop-blur-sm border border-white/10 rounded-3xl shadow-md overflow-hidden">
 <div className="p-5">
